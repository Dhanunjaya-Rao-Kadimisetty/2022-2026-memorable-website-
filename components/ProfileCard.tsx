        ...
        <div className="absolute inset-x-0 bottom-0 p-5">
          ...
          <div className="mt-3 flex gap-3 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
            {profile.whatsapp_url && (
              <div className="text-zinc-400 hover:text-emerald-400 transition-colors">
            ...
            {profile.instagram_url && (
              <div className="text-zinc-400 hover:text-pink-500 transition-colors">
